...
async def santet(client: Client, message: Message):
    ...
    # CUSTOM CODE FROM SEP

@Client.on_message(filters.command(["bln", "bulan"], cmd) & filters.me)
async def bulan(client: Client, message: Message):
    await edit_or_reply(message, "bulan.")
...
@Client.on_message(filters.command("terkadang", cmd) & filters.me)
async def terkadang(client: Client, message: Message):
    typew = await edit_or_reply(message, "`Terkadang`")
    sleep(1)
...
@Client.on_message(filters.command("r", cmd) & filters.me)
async def r(client: Client, message: Message):
    if message.fwd_from:
        return
...
@Client.on_message(filters.command("gombal", cmd) & filters.me)
async def gombal(client: Client, message: Message):
    typew = edit_or_reply(message, "`Hai, I LOVE YOU 💞`")
    sleep(1)
...
add_command_help(
    ...
    [
        ...
        ["bulan", "It Will Send Moon Animation."],
        ["terkadang", "It Will Send Terkadang Animation."],
        ["r", "It Will Send Love Server Animation."],
        ["gombal", "It Will Send Gombal Animation."],
        ["ular", "It Will Send Ular Art."],
        ["tengkorak", "It Will Send Tengkorak Art."],
        [
            "pat",
            "To get a pat gifs",
        ],
